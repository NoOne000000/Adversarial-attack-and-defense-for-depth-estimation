...
class DRNSeg(nn.Module):
    def __init__(self, model, classes=19, pretrained_model=None,
...
def drn_d_22(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(model_zoo.load_url(model_urls['drn-d-22'], 'models/pretrained'))
    return model
...
def drn_d_38(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(model_zoo.load_url(model_urls['drn-d-38'], 'models/pretrained'))
    return model
...
def drn_d_54(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(model_zoo.load_url(model_urls['drn-d-54'], 'models/pretrained'))
    return model
